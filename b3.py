...
diretorio_destino = 'C:\\Users\\jeffe\\OneDrive\\Área de Trabalho\\James'
...
while Ano <= 2022:
    ...
    f_bovespa = 'C:\\Users\\jeffe\\OneDrive\\Área de Trabalho\\James\\' + 'COTAHIST_A' + str(Ano) + '.txt'
...
diretorio_arquivos = 'C:\\Users\\jeffe\\OneDrive\\Área de Trabalho\\James'

#Diretório onde o arquivo combinado será salvo
diretorio_saida = 'C:\\Users\\jeffe\\OneDrive\\Área de Trabalho\\James'
...
os.chdir("C:\\Users\\jeffe\\OneDrive\\Área de Trabalho\\James")
...
#exportar para csv
combined_csv.to_csv( "uniao_csv.csv", index=False, encoding='utf-8-sig')
